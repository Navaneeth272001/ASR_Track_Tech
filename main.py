"""
main.py - Updated entry point with class config support

No changes needed to main loop - the config update happens automatically
when messages arrive on racetrack/config/classes topic.
"""
...
async def main():
    ...
    if DEBUG:
        print("[main] cancelling audio task...")
    ...
    try:
        ...
        if DEBUG:
            print("[main] audio task cancelled cleanly")
